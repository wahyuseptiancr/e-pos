...
@section('title-header', 'Ubah data transaksi')
@section('breadcrumb')
        ...
        <div class="col-12">
            <div class="card shadow">
                <div class="card-header bg-transparent border-0 text-dark">
                    <h5 class="mb-0">Formulir Ubah data transaksi</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('transactions.update', $transaksi->id) }}" method="POST" role="form" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control @error('product_id') is-invalid @enderror" id="product_id" name="product_id">
                                        ...
                                        @foreach ($products as $product)
                                            <option value="{{ $product->id }}" @if ($transaksi->product_id == $product->id) selected @endif>
                            ...
                            <div class="col-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('qty') is-invalid @enderror" id="qty"
                                        placeholder="Jumlah / Qty produk" name="qty" value="{{$transaksi->qty}}">
